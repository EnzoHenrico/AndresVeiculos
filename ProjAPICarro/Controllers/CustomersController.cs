...
namespace ProjAPICarro.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Income,PDFDocument,Document,Name,BirthDate,Phone,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Income,PDFDocument,Document,Name,BirthDate,Phone,Email")] Customer customer)
        {
